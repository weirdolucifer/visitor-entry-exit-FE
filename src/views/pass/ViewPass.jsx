                ...
                <div className="col-span-2 flex flex-col space-y-4">
                    <div className='p-2'>
                        ...
                        <div className="flex justify-left p-2">
                            <InfoItem label="Valid-Till" value={new Date(passData?.validity).toLocaleString('en-IN', { year: 'numeric', month: '2-digit', day: '2-digit', hour: '2-digit', minute: '2-digit', hour12: false })} />
                        </div>
                    </div>
                </div>
            </div>
