                    ...
                    <table className="text-left w-full border-collapse">
                        <thead>
                            <tr>
                                ...
                                <th className="py-4 px-6 bg-grey-lightest font-bold uppercase text-sm text-grey-dark border-b border-grey-light text-center">Local Pass ID</th>
                                ...
                                <th className="py-4 px-6 bg-grey-lightest font-bold uppercase text-sm text-grey-dark border-b border-grey-light">Pass Image</th>
                            </tr>
                        </thead>
                        <tbody>
                                    ...
                                    <td className="py-1 px-1 border-b border-grey-light">
                                        <div className="flex justify-center">
                                            <div className="inline-block h-16 w-16 border-2 border-gray-300 rounded-full overflow-hidden bg-customGreen">
                                                {pass.pass_image ? (
                                                    <img src={`data:image/jpeg;base64,${pass.pass_image}`} alt="Pass" />
                                                ) : (
                                                    <div className="h-full w-full flex items-center justify-center text-white bg-customGreen">
                                                        {pass.pass_type ? pass.visitor_name.charAt(0).toUpperCase() : 'N'}
                                                    </div>
                                                )}
                                            </div>
                                        </div>
